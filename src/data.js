...
export const data = [
...

    {
        ...
        photo: mexican,
        name: 'Мексиканская',
        description: 'Колбаса Пепперони, помидоры, перец, морковь по-корейски под сыром Гауда на фирменном томатном соусе.',
        price: 350
    },
...

    {
        ...
        photo: chef,
        name: 'От шефа',
        description: 'Бекон, язык, цыплёнок, шампиньоны, томаты, болгарский перец под сыром Моцарелла на чесночном соусе.',
        price: 500
    },
